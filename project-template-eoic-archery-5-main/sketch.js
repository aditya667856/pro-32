...
// Write code to detect collision between player arrow and opponent
 ...
 var collision = Matter.SAT.collides(playerArrows[playerArrows.length-1].body ,computer.body);

if(collision.collided){
 console.log("remove playerArrows")
}
}

function handleComputerArrowCollision() {
  //Write code to detect collision between computer arrow and opponent
  var collision = Matter.SAT.collides(computerArrows[computerArrows.length-1].body , player.body);

  if(collision.collided){
    console.log("remove computerArrows")
  }
